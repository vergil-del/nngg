...
const langData = {
  "ar_SY": {
    "pokemon.noPokémon": "ليس لديك أي بوكيمون. استخدم `pokemon buy` لشراء واحد.",
    "pokemon.buySuccess": "مبروك! لقد اشتريت بوكيمون اسمه {pokemonName}!",
    "pokemon.buyFailure": "ليس لديك ما يكفي من الائتمان لشراء بوكيمون.",
    "pokemon.feedSuccess": "لقد أطعمْت {pokemonName}! مستوى البوكيمون زاد إلى {newLevel}.",
    "pokemon.feedSuccessEvolved": "لقد أطعمْت البوكيمون المتطور {pokemonName}! مستوى البوكيمون زاد إلى {newLevel}.",
    "pokemon.feedFailure": "ليس لديك بوكيمون لتطعمه.",
    "pokemon.checkStatus": "📛 اسم البوكيمون: {pokemonName}\n🆙 المستوى: {pokemonLevel}\n⬆️ قوة البوكيمون: {pokemonPower}\n🪙 القيمة القابلة للتحصيل: ${pokemonValue}\n━━━━━━━━━━━━\n🏆 الفوز: {totalWins}\n🪦 الخسارة: {totalLosses}",
    "pokemon.menuOptions": "◦❭❯❱【لعبة بوكيمون】❰❮❬◦\n\n1. `pokemon battle` » بدء معركة بوكيمون.\n2. `pokemon list` » قائمة أسماء البوكيمون المتاحة.\n3. `pokemon buy <اسم البوكيمون>` » شراء بوكيمون.\n4. `pokemon nickname <اللقب>` » تعيين لقب للبوكيمون.\n5. `pokemon feed` » إطعام البوكيمون.\n6. `pokemon check` » التحقق من معلومات البوكيمون.\n7. `pokemon challenge @user` » تحدي مستخدم آخر إلى معركة بوكيمون.\n • `poke accept` » قبول التحدي.\n • `poke decline` » رفض التحدي.\n8. `pokemon trade @user` » تبادل بوكيمون مع مستخدم آخر.\n9. `pokemon confirm @user` » قبول التبادل من مستخدم آخر.\n10. `pokemon collect` » تحصيل القيمة المتزايدة للبوكيمون.\n11. `pokemon release` » إطلاق البوكيمون الحالي."
  }
};
